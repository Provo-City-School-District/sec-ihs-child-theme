			...
			<h1>Independence High School</h1>
				...
				<aside>
					<ul class="sociallinks">
						...
						<li><a href="https://www.facebook.com/groups/IHSprovoUT/"><img src="<?php echo get_template_directory_uri() .'/assets/icons/socialmedia-facebook-white.svg' ?>" alt="Link to Facebook" /></span>
							</a>
						</li>
					</ul>
					<!-- Search Form -->
